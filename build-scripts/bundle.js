...
module.exports.config = {
  dynalite({ isProdBuild, latestBuild }) {
    return {
      entry: {
        entrypoint: path.resolve(paths.dynalite_dir, "src/entrypoint.ts"),
      },
      outputPath: outputPath(paths.dynalite_output_root, latestBuild),
      publicPath: publicPath(latestBuild, paths.dynalite_publicPath),
      isProdBuild,
      latestBuild,
      isHassioBuild: true,
    };
