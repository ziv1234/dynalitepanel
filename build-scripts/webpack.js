...
const createDynaliteConfig = ({ isProdBuild, latestBuild }) =>
  createWebpackConfig(bundle.config.dynalite({ isProdBuild, latestBuild }));

module.exports = {
  createDynaliteConfig: createDynaliteConfig,
};
